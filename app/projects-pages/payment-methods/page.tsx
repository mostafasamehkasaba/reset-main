                ...
                <tbody>
                  {filteredMethods.map((method, index) => (
                    <tr key={method.id} className={index % 2 === 0 ? "bg-white" : "bg-slate-50"}>
                      <td className="px-2 py-2 sm:px-3 sm:py-3 text-center text-slate-700">{method.id}</td>
                      <td className="px-2 py-2 sm:px-3 sm:py-3 text-right font-semibold text-slate-800">{method.name}</td>
                      <td className="px-2 py-2 sm:px-3 sm:py-3 text-center text-slate-700">{method.payments}</td>
                      <td className="px-2 py-2 sm:px-3 sm:py-3 text-center font-semibold text-emerald-700">{method.total}</td>
                      <td className="px-2 py-2 sm:px-3 sm:py-3 text-center text-slate-600">{method.desc}</td>
